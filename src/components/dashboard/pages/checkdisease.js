                ...
                <div className='main_body'>
                    ...
                    <div className='container'>
                        <div className='imageUpload'>
                            <p style={{ textDecoration: 'underline', fontWeight: '500', color: 'black' }}>Check For Diabetic Retinopathy:</p>
                            <form className='form_img'>
                                ...
                                <p className='classify' onClick={handleClassifyImage}>Get Report</p>
                            </form>
                        </div>
                    </div>
                </div>
